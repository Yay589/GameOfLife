...
for line in lines:
    if line.strip().startswith(("randomStartOn", "kindnessON", "deseaseON", "educationON", "nourriturePref_quantite", "tribesON", "tribesRandom")):
...
button_positions = {
    ...
    "nourriturePref_quantite": (3 * window_size[0] // 4, window_size[1] // 2 - 100),
    "tribesON": (3 * window_size[0] // 4, window_size[1] // 2 - 50),
    "tribesRandom": (3 * window_size[0] // 4, window_size[1] // 2),
